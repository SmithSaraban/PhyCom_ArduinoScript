int btnRed = 2; //Btnทุกอัน ขาฝั่งซ้ายเชื่อมกับ arduino ต่อด้วย resistor 220 โอห์มที่ต่อมาจาก VCC
int btnGreen = 3; //ขาขวาต่อเข้า GND
int btnBlue = 4;
int red = 5; //ขา cathode ต่อเข้า VCC ขา rgb ต่อตัวต้านทานแล้วต่อ arduino
int green = 6;
int blue = 7;
